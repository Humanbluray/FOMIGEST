    ...
    def __init__(self, cp: object, infos: dict):
        ...
        self.content = ft.Row(
            controls=[
                ft.Row(
                    controls=[
                        ft.TextField(**readonly_field_style, width=300, value=infos["nom"], label="Nom fournisseur",
                                     prefix_icon=ft.icons.PERSON_OUTLINE_OUTLINED),
                        ft.TextField(**readonly_field_style, width=120, label="initiales", value=infos["initiales"]),
                    ]
                ),
                ft.Row(
                    controls=[
                        CtButton("edit_outlined", "Modifier", infos, self.open_edit_window),
                        CtButton(ft.icons.LIST, "Voir commandes", infos, self.voir_commandes)
                    ], spacing=0
                )
        ...
        self.main_window = ft.Container(
            ...
            content=ft.Column(
                ...
                controls=[
                    ft.Column(
                        controls=[
                            ft.Text("Liste des fournisseurs".upper(), size=16, font_family="Poppins Bold"),
                                ...
                                controls=[
                                    ft.Row(
                                        controls=[
                                            ...
                                            ft.Text("Modifier fournisseur".upper(), size=14, font_family="Poppins Medium")
                                        ]
                                    ),
                                ...
                                controls=[
                                    ft.Row(
                                        controls=[
                                            ...
                                            ft.Text("Créer fournisseur".upper(), size=14, font_family="Poppins Medium")
                                        ]
                                    ),
